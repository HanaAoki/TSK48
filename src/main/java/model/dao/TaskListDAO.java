...
public class TaskListDAO {
	...
	public List<TaskBean> selectSomeTask(int n) throws SQLException, ClassNotFoundException {
		List<TaskBean> taskList = new ArrayList<TaskBean>();
		StringBuilder sql = new StringBuilder();
		int num = 2;	//表示行数
	...
	public List<TaskBean> selectSomeTask() throws SQLException, ClassNotFoundException {
		int n = 0;
		
		return selectSomeTask(n);
	}
}
